...
public class ConversionUtils {
	...
	public static Employee convertDtoToNewEntity(EmployeeDto employeeDto, String createdBy) {
		...
		return new Employee(employeeDto.getId(), employeeDto.getName(), employeeDto.getEmail(),
				...
				employeeDto.getUsername(), employeeDto.getPassword(), employeeDto.getRoles(), createdBy, createdTime,
	...
	public static Employee convertDtoToUpdateEntity(EmployeeUpdateReqDto employeeDto, String updatedBy,
		...
		return new Employee(employee.getId(), empName, empEmail, department, employee.getDesignation(), empPhoneNumber,
				employee.getUsername(), employee.getPassword(), employee.getRoles(), createdBy, createdTime, updatedBy,
				updatedTime);
	}
	...
	public static EmployeeRespDto convertEntityToDto(Employee employee) {
		return new EmployeeRespDto(employee.getId(), employee.getName(), employee.getEmail(), employee.getPhoneNumber(),
				employee.getDepartment(), employee.getDesignation(), employee.getUsername(), employee.getRoles());
	}
